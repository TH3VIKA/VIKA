...
if redis:get(boss..'lock_service') then sendMsg(msg.to.id,msg.id_,'🚸 ~>  تہ‌‏م  تفعـيل البوت  \n👨🏽‍🔧 ~> * وتم رفع جمـيع الادمنيه \n✓','md')
else sendMsg(msg.to.id,msg.id_,'🚸 ~>  تہ‌‏م   تـفـعـيـل آلمـجمـوعهہ‏‏ \n✓️','md') end
...
return sendMsg(msg.to.id,0,'🚸 *~>* عذرا البوت ليس ادمن  في المجموعه \n👨🏻‍✈️*~>* يرجى ترقيته ادمن لتتمكن من تفعيل البوت ✓️','md')
else
for k,v in pairs(data.members_) do
...
function modrem(msg)
if not is_sudo(msg) then return '‼️*~>* انـت لسـت الـمـطـور 'end
...
return '🚸* ~>*    تہ‌‏م تعـطيل المـجموعه  ⚠️'
end
