...
return 'عزيزي هذه هي الاحصائيات  : 🔖 \n\n♣️┫ عدد المجموعات هي »  '..#group..'\n ♠️┫ عدد اعضاء الخاص » '..#pv..'\n——'
end
---------------[End Function data] -----------------------
...
else sendMsg(msg.to.id,msg.id_,"🚸┫ ماكو صوره حبيبي الغالي   ...\n-",'md')
end end, nil)
...
if string.len(r2) > 80 then return "💢¦  ما اكدر اكله اكثر من 60 حرف خاف اموت 🙌🏾" end
if check_name(r2)~='الاسم سبام 📛' then
...
elseif r== "شلونكم" or r== "شلونك" or r== "شونك" or r== "شونكم"   then return  "احســن مــن آنْٺهِ شُځٻآرڪ شُوُ مْآڪوُ  😹🌚"
elseif r== "صاكه"  then return  "   يَآٻهِ ڊﺰلُيَ صًوُرٺهِهِ😍❤️آوُوُوُوُيَلُيَ  🐸💔"
elseif r== "وينك"  then return   "دوۣر بۣۗـۙكۣۗـۙلَبۣۗـۙكۗ وۣتۣۗـۙلَكۣۗـۙآنۣۗـۙيۣۗہ 😍😍❤️"
elseif r== "منورين"  then return  "من نورك عۣۗـۙيۣۗہنۣۗـۙيۣۗہ ❤️🌺"
elseif r== "هاي"  then return  "هۣۗہآيۣۗہآتۣۗ عۣۗـۙمۣۗـۙريۣۗہ 😍🍷"
elseif r== "🙊"  then return  "فديت آلَخۣۗـۙجۣۗـۙوۣلَ 🙊 😍"
elseif r== "😢"  then return  "لَتۣۗـۙبۣۗـۙجۣۗـۙيۣۗہ حۣۗـۙمۣۗـۙبۣۗـۙيۣۗہ  😢"
...
elseif r== "مح"  then return  "محۣۗـۙآتۣۗ حۣۗـۙحۣۗـۙحۣۗـۙحۣۗـۙحۣۗـۙيۣۗہآتۣۗـۙيۣۗہ🙈❤"
...
elseif r== "اكرهك"  then return  "ديله شۣۗـۙلَوۣنۣۗـۙ آطۣۗـۙيۣۗہقۣۗ خۣۗـۙلقۣۗـۙتۣۗـۙكۣۗـۙ اني😾🖖🏿🕷"
elseif r== "اريد اكبل"  then return  "خخ اني هم اريد اكبۣۗـۙلَ😹🙌️"
elseif r== "ضوجه"  then return  "شي اكيد الكبل ماكو 😂 لو بعدك/ج مازاحف/ة 🙊😋"
elseif r== "اروح اصلي"  then return  "انته حۣۗـۙآفۣۗـۙظۣۗ سۣۗـۙوۣرة آلَفۣۗـۙآتۣۗـۙحۣۗـۙهۣۗہ😍❤️️"
elseif r== "صاك"  then return  "زاحفه 😂 منو هذا دُزۣيۣۗہلَيۣۗہ صۣۗـۙوۣرتۣۗـۙهۣۗہ"
elseif r== "اجيت" or r=="اني اجيت" then return  "كْـٌﮩٌﮧٌ﴿😍﴾ـﮩٌول الـ୭ـهـٌ୭ـْلا❤️"
elseif r== "طفي السبلت"  then return  "تم اطفاء السۣۗـۙبۣۗـۙلَتۣۗـۙ 🌚🍃"
elseif r== "شغل السبلت"  then return  "تم تشغيل السبلت بنجاح بردتو مبردتو معليه  🌚🍃"
elseif r== "حفلش"  then return  "افلش راسك 🤓"
elseif r=="نايمين" then return  "ني سهران آحۣۗـۙرسۣۗـۙكۣۗـۙمۣۗ😐🍃'"
...
elseif r== "حروح اسبح" then return  "وۣآخۣۗـۙيۣۗہرآ آلَوۣصۣۗـۙخۗ 😂"
elseif r== "😔"  then return  "ليش الحلو ضايج ❤️🍃"
elseif r== "☹️"  then return  "لضوج حبيبي 😢❤️🍃"
elseif r== "جوعان"  then return  "هۣۗہآكۣۗـۙ رجۣۗـۙلَيۣۗہ آكۣۗـۙلَهۣۗہهۣۗہ 😐😂"
elseif r== "تعال خاص" or r== "خاصك" or r=="شوف الخاص" or r=="شوف خاص" then return  "عۣۗـۙيۣۗہبۣۗـۙ آبۣۗـۙنۣۗـۙيۣۗہ  😉"
...
elseif r== BOT_NAME and r2=="شلونك" then return "احســن مۣۗـۙنۣۗـۙ آمنۣۗـۙتۣۗـۙهۣۗہ شۣۗـۙخۣۗـۙبۣۗـۙآركۣۗـۙ شۣۗـۙوۣ مۣۗـۙآكۣۗـۙوۣ 😹🌚"
elseif r== "يومه فدوه"  then return  "فدؤه الج عۣۗـۙيۣۗہوۣنۣۗـۙيۣۗہ 😍😙"
elseif r== "افلش"  then return  "@vikaiq عام من 30 بوت 😉"
...
elseif r== "😡"  then  return  "وۣيۣۗہ وۣيۣۗہ وۣيۣۗہ آبۣۗـۙر آبۣۗـۙردُدُدُُزۣ  🚒"  
...
elseif r== "البوت واكف" then return  "لَآ مۣۗـۙآوۣآكۣۗـۙفۣۗـۙ يۣۗہلَ وۣصۣۗـخۣۗ 😐"
elseif r== "ضايج"  then return  "ليش ضايج حۣۗـۙيۣۗہآتۣۗـۙيۣۗہ"
elseif r== "ضايجه"  then return  "منو مضوجج كبدايتي"
elseif r== "😳" or r== "😳😳" or r== "😳😳😳" then return  "ها بس لا شفت خالتك آلَسۣۗـۙوۣدُهۣۗہ 😳😹🕷"
...
elseif r== "بوت"  then return  "أسمي "..BOT_NAME.." ఠ ͟ಠ"
...
elseif r== "تبادل"  then return  "كافي ملينه  😕💔"
elseif r== "عاش"  then return  "الحلو 🌝🌷"
elseif r== "مات"  then return  "أبو الحمامات 🕊🕊"
elseif r== "ورده" or r== "وردة"  then return  "أنت/ي  عطرهاا  🌹🌸"
elseif r== "شسمك"  then return  "مكتوب فوك 😪"
elseif r== "فديت" or r=="فطيت" then return  "فدآگ/ج 💞🌸"
elseif r== "واو"  then return  "قمـيل 🌝🌿"
elseif r== "زاحفه" or r== "زاحفة"  then return  "لو زاحفتلك جان ماكلت زآحہفہهہ 🌝🌸"
elseif r== "حبيبي" or r=="حبي" then return  "بعد روٌحہيہ 😍❤️ تہفہضہل"
elseif r== "حبيبتي" then return  "تحبك وتحب عہعہعہعہليہكہ 🌝🌷"
elseif r== "حياتي" then return  "ها حہيہآتہيہ  😍🌿"
elseif r== "عمري" then return  "خلصته ديہآحهہ وٌزحہفہ 🌝🌿 "
elseif r== "اسكت" then return  "وك مہعہلم 🌚💞"
elseif r== "بتحبني" then return  "مہآحہبہكہكہ 😂 😍🌷"
elseif r== "المعزوفه" or r=="المعزوفة" or r=="معزوفه" then return  "  مابي حيل ولك 😂"
elseif r== "موجود" then return  "تہفہضہل عہزيہزيہ 🙈 🌝🌸"
elseif r== "اكلك" then return  ".كول "
